...
const collegeCoords = { lat: 50.4501, lon: 30.5234 }; // Координати коледжу (Київ)
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function showMap(lat, lon) {
    mapElement.innerHTML = ""; // Очищаємо карту, якщо вона вже існує
    const map = L.map(mapElement).setView([lat, lon], 13); // Центруємо на поточних координатах
